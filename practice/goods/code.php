...
$_SESSION['yzm'] = strtoupper($randCode);
ImageCode($randCode,65,28);
 ...
 * @param $height 高度
 * */
function ImageCode($string = '', $width = 70, $height = 37)
{
	...
	for($i = 0; $i < 32; $i++)
	{
		...
		{
			$colorRandom = mt_rand(0,sizeof($colorList)-1);
			imagesetpixel($image, rand()%70 , rand()%30 , $colorList[$colorRandom]);
